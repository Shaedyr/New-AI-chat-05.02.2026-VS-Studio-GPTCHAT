"""
Landkreditt sheet configuration.
"""

from app_modules.insurers.landkreditt.sheets.sammendrag import (
    CELL_MAP as SAMMENDRAG_MAP,
    transform_data as transform_sammendrag,
)
from app_modules.insurers.landkreditt.sheets.fordon import (
    CELL_MAP as FORDON_MAP,
    transform_data as transform_fordon,
)
from app_modules.insurers.landkreditt.sheets.yrkesskade import (
    CELL_MAP as YRKESSKADE_MAP,
    transform_data as transform_yrkesskade,
)
from app_modules.insurers.landkreditt.sheets.alminnelig_ansvar import (
    CELL_MAP as ALMINNELIG_ANSVAR_MAP,
    transform_data as transform_alminnelig_ansvar,
)
from app_modules.insurers.landkreditt.sheets.prosjekt_entreprenor import (
    CELL_MAP as PROSJEKT_ENTREPRENOR_MAP,
    transform_data as transform_prosjekt_entreprenor,
)
from app_modules.insurers.landkreditt.sheets.helse import (
