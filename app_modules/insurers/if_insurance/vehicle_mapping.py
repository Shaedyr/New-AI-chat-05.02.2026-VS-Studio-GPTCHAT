# app_modules/insurers/if_insurance/vehicle_mapping.py
"""
FORDON mapping (if).
Hard-isolated: this module only runs if extractor logic.
"""
...
def transform_data(extracted: dict) -> dict:
    ...
    st.write("?? FORDON: if isolated mapping")

    try:
        vehicles = extract_if_vehicles(pdf_text) or []
    except Exception as exc:
        st.error(f"if extractor failed: {exc}")
        return out
