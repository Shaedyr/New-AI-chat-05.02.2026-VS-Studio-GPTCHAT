# app_modules/insurers/gjensidige/vehicle_mapping.py
"""
FORDON mapping (gjensidige).
Hard-isolated: this module only runs gjensidige extractor logic.
"""
...
def transform_data(extracted: dict) -> dict:
    ...
    st.write("?? FORDON: gjensidige isolated mapping")

    try:
        vehicles = extract_gjensidige_vehicles(pdf_text) or []
    except Exception as exc:
        st.error(f"gjensidige extractor failed: {exc}")
        return out
